    ...
    <div className="pt-12 md:flex items-center justify-between  w-11/12 mx-auto">
      ...
      <div className="pt-8 md:w-[48%] xl:w-[54%] capitalize">
        ...
        <h1 className="text-blue_c font-secondary_font text-3xl  lg:text-2xl xl:text-5xl leading-8">
          The Best Resort in Bangalore for weekend getaway
        </h1>
        <p className="text-[#292929] font-light pt-8 text-lg leading-7 lg:text-lg xl:text-xl">
          Located just 25 km from Bangalore, on Kanakapura Road, The Starry
          Nights Adventure Resort is the ultimate destination for adventure,
          relaxation, and special events. Whether you're seeking a day outing
          resort in Bangalore, a serene escape for couples, or a venue for
          corporate events and weddings, The Starry Nights promises an
          extraordinary experience for all For a perfect blend of adventure,
          relaxation, and impeccable service, visit The Starry Nights – your
          go-to resort for corporate outings, team-building events, weddings,
          and unforgettable day outings. Experience why we are one of the best
